...
<br/><br/>
<openmrs:message code="uncaughtException.help.text1"/><a
        href="<%= request.getContextPath() %>/help.htm"><openmrs:message code="uncaughtException.help.text2"/></a><br/>
<openmrs:message code="uncaughtException.contact"/>

<br/><br/>

<a href="#" onclick="showOrHide()" id="toggleLink" style="font-size: 12px;"><openmrs:message
